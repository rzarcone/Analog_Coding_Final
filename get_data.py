"""Functions to import and process memristor data. -- Ryan Zarcone"""
...
def get_memristor_data(path, pcm_device, n_mem, num_ext=5, norm_min=-1., norm_max=1., normalize=True):
    """
